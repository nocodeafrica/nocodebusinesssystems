...
export default function EditProductPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log("Updating product:", params.id, formData)

      // Redirect to product detail
      router.push(`/inventory/products/${params.id}`)
    } catch (error) {
    ...
    <div className="flex flex-col">
      ...
      <div className="border-b bg-white px-4 py-6 sm:px-6 lg:px-8">
        <div className="flex items-center gap-4">
          <Link href={`/inventory/products/${params.id}`}>
            <Button variant="ghost" size="icon" aria-label="Back to product details">
            ...
            <CardContent className="space-y-4">
              <div className="p-3 bg-blue-50 border border-blue-200 rounded-lg">
                <p className="text-sm text-blue-800">
                  Note: To adjust stock quantities, use the "Adjust Stock" feature from the product detail page or the stock management section.
                </p>
              </div>
